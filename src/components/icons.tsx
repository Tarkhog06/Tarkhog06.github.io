...
/**
 * Brand icons. lucide-react v1 dropped social/brand glyphs, so GitHub and
 * LinkedIn are provided here as inline SVGs (paths from Simple Icons) that
 * accept the same className/size props as lucide icons.
 */
